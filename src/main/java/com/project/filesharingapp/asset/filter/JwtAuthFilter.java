package com.project.filesharingapp.asset.filter;

import com.project.filesharingapp.asset.model.ServiceResponse;
import com.project.filesharingapp.asset.service.JwtService;
...
public class JwtAuthFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException, ExpiredJwtException {
        ...
        if (path.startsWith("/api/auth") || path.startsWith("/api/user/create")) {
